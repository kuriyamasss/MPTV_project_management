      ...
      <div style={{ overflow: 'auto', flex: 1 }}>
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 14 }}>
            <thead style={{ background: '#f9fafb', position: 'sticky', top: 0, zIndex: 10 }}>
                <tr>
                    <th style={{ padding: '12px', textAlign: 'left', borderBottom: '1px solid #e5e7eb', minWidth: 200 }}>ä»»åŠ¡åç§°</th>
                    <th style={{ padding: '12px', textAlign: 'left', borderBottom: '1px solid #e5e7eb', width: 130 }}>é¢„è®¡å¼€å§‹</th>
                    <th style={{ padding: '12px', textAlign: 'left', borderBottom: '1px solid #e5e7eb', width: 130 }}>é¢„è®¡ç»“æŸ</th>
                    <th style={{ padding: '12px', textAlign: 'left', borderBottom: '1px solid #e5e7eb', width: 130, color: '#2563eb' }}>å®žé™…å¼€å§‹</th>
                    <th style={{ padding: '12px', textAlign: 'left', borderBottom: '1px solid #e5e7eb', width: 130, color: '#2563eb' }}>å®žé™…ç»“æŸ</th>
                    <th style={{ padding: '12px', textAlign: 'left', borderBottom: '1px solid #e5e7eb', width: 200 }}>å¤‡æ³¨</th>
                </tr>
            </thead>
            <tbody>
                {tasks.map((task: any) => {
